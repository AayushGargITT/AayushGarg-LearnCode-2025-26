        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LlmProvider = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LlmApiKey = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SchedulerIntervalHours = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskFlagsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilisationPercent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Allocation_UtilisationPercent", "\"UtilisationPercent\" BETWEEN 0 AND 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursLogged = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityTags_Timesheets_TimesheetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityTags_TimesheetId_TagName",
                table: "ActivityTags",
                columns: new[] { "TimesheetId", "TagName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Timesheets",
                columns: new[] { "EmployeeId", "ProjectId", "WeekStartDate" },
                unique: true);
